...
#Min
csvsort -c revenue tmdb-movies.csv | head -n 2 | csvcut -c id,original_title,revenue_adj
#Max:
csvsort -c revenue -r tmdb-movies.csv | head -n 2 | csvcut -c id,original_title,revenue_adj

#4
csvcut -c revenue tmdb-movies.csv | csvstat --sum

#5 
csvsort -c revenue -r tmdb-movies.csv | head -n 11 | csvcut -c id,original_title,revenue_adj
